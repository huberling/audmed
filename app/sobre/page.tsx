...
<div className="roww clçaa">
    <div className="descritivos2 col-md-4 -ml-12">
    ...
    <div className="descritivos2 desc1 col-md-4">
    ...
    <div className="descritivos2 desc2 col-md-4">
