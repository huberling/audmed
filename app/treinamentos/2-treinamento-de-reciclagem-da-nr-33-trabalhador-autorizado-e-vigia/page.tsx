...
import Treinamento02 from '../../../public/Treinamento2.jpg'
    ...
    return(
        ...
        <div className="sobre">
            ...
            <ol className="breadcrumb">
                ...
                <li className="ads">
                Treinamento de reciclagem da NR-33 trabalhador autorizado e vigia
                </li>
            </ol>
            </div>
    </section>
            ...
            <div className="col-md-10 ml-8"  >
                <div className="semmarginbotton">
                    <div className="clearflix">
                        ...
                        <Image src={Treinamento02} alt=""/>
                        </div>
                        <div><span className='font-bold'>
                            OBJETIVO
                        </span></div>
                        <div><br/></div>
                        <div>Aprimorar conceitos básicos de segurança para realização de trabalhos em espaço confinado capacitando pessoas conforme NR 33.
                        </div>    
                        <div><br/></div>    
                        ...
                        <div><br/></div>    
                        <div>Indivíduos com experiência prévia cuja atividade possa apresentar diversos níveis de complexidade.</div>  
                        <div><br/></div>    
                        <div><span className='font-bold'>
