            ...
            <div className="col-md-10 ml-4 md:ml-8 lg:ml-8"  >
                <div className="semmarginbotton">
                    <div className="clearflix">
                        ...
                        <div><br/></div>
                        <div>Norma Regulamentadora que tem como objetivo estabelecer as condições mínimas de segurança para os trabalhadores que, na sua atuação, interagem direta ou indiretamente com instalações elétricas.</div>    
                        <div><br/></div>    
                        <div><span className="font-bold mt-5">
                        PÚBLICO ALVO
                        </span></div>    
                        <div><br/></div>    
                        <div>Eletricistas, eletro-técnicos, eletricistas, meio oficial eletricista, ajudantes de elétrica, técnicos, profissionais de segurança industrial e qualquer outra função que direta ou indiretamente, interajam em instalações elétricas e serviços com eletricidade.</div>  
                        <div><br/></div>    
                        <div><span className='font-bold'>
                            PROGRAMA (PREVISTO NA NR 10)
                        </span></div>  
                        <div><br/></div>  
                        <div> 
                            - 
